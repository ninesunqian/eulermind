...
public class Visualization {
    ...
    private class VisualTreeRootChanger implements TreeRootChangeListener {
    	Tree m_t;
    	VisualTree m_vt;
    	
    	public VisualTreeRootChanger(Tree t, VisualTree vt) {
    		m_t = t;
    		m_vt = vt;
		}
            ...
            Predicate filter, Schema nodeSchema, Schema edgeSchema)
    {
        ...
        tree.addRootChangeListener(new VisualTreeRootChanger(tree, vt));
