...
public class TreeView extends Display {
    ...
    public class OrientAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            Tree tree = (Tree) getVisualization().getSourceData("tree");
        	Node root = tree.getRoot();
        	
        	String old_root_name = (String)root.get("name");
        	System.out.println("old root is " + old_root_name );	
        	
        	Node ch1 = tree.addChild(root);
        	ch1.set("name",  "new_child_" + key);
        	key++;
        	
        
        	Graph graph = (Graph)tree;
        	Node newRoot = graph.addNode();
        	newRoot.set("name", "new_root");
        	
        	graph.addEdge(newRoot, root); 
